/**
 * @file TimeSeriesCollectionClient.cpp
...
struct TimeSeriesCollectionClient::Impl
{
    ...
    BipedalLocomotion::YarpUtilities::TimeSeriesCollectionMetadataService rpcInterface;
...
TimeSeriesCollectionClient::TimeSeriesCollectionClient()
{
    m_pimpl = std::make_unique<Impl>();
}

TimeSeriesCollectionClient::~TimeSeriesCollectionClient() = default;

bool TimeSeriesCollectionClient::initialize(
    std::weak_ptr<const ParametersHandler::IParametersHandler> handler)
{
    constexpr auto logPrefix = "[TimeSeriesCollectionClient::initialize]";
...
bool TimeSeriesCollectionClient::disconnect()
{
...
bool TimeSeriesCollectionClient::connect()
{
...
bool TimeSeriesCollectionClient::getMetadata(
    BipedalLocomotion::YarpUtilities::TimeSeriesCollectionMetadata& metadata)
{
    if (!m_pimpl->isConnected)
    {
        log()->error("[TimeSeriesCollectionClient::getMetadata] Please call connect before asking "
                     "for "
                     "the metadata");
        return false;
    }
...
BipedalLocomotion::YarpUtilities::TimeSeriesCollection*
TimeSeriesCollectionClient::readData(bool shouldWait /*= true */)
{
