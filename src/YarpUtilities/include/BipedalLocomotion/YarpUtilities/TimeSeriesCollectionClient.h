...
#ifndef BIPEDAL_LOCOMOTION_YARP_UTILITIES_TIME_SERIES_COLLECTION_CLIENT_H
#define BIPEDAL_LOCOMOTION_YARP_UTILITIES_TIME_SERIES_COLLECTION_CLIENT_H
...
/**
 * TimeSeriesCollectionClient is a class that implements that allows to receive a
 * TimeSeriesCollection from a TimeSeriesCollectionServer.
 */
class TimeSeriesCollectionClient
{
public:
    /**
     * Constructor.
     */
    TimeSeriesCollectionClient();

    /**
     * Destructor.
     */
    virtual ~TimeSeriesCollectionClient();
     ...
     * @return a pointer to the TimeSeriesCollection. The ownership of the pointer is controlled by
     * the yarp port.
     */
    BipedalLocomotion::YarpUtilities::TimeSeriesCollection* readData(bool shouldWait = true);
...
#endif // BIPEDAL_LOCOMOTION_YARP_UTILITIES_TIME_SERIES_COLLECTION_CLIENT_H