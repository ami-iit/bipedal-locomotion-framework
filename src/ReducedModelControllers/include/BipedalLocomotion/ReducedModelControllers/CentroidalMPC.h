...
public:
     ...
     * |   `number_of_maximum_contacts`  |       `int`      |                            Integer representing the maximum namber of contact that can be established. For a bipedal is in general 2 (the feet) for a quadrupet 4.                           |    Yes    |
     * |           `com_weight`          | `vector<double>` |                       Weight of the CoM in the cost function. The Vector must contains three elements that will correspod to the weight in the x y and z coordinates.                        |    Yes    |
