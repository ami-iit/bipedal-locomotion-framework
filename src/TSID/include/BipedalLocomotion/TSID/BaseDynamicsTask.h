/**
 * @file BaseDynamicsTask.h
 * @authors Giulio Romualdi
 * @copyright 2020 Istituto Italiano di Tecnologia (IIT). This software may be modified and
 * distributed under the terms of the GNU Lesser General Public License v2.1 or any later version.
 */

#ifndef BIPEDAL_LOCOMOTION_TSID_BASE_DYNAMICS_H
#define BIPEDAL_LOCOMOTION_TSID_BASE_DYNAMICS_H
...
/**
 * BaseDynamicsTask is a concrete implementation of the Task. Please use this element if you
 * want to consider the base dynamics only.
 * The task represents the following equation
 * \f[
 * M_{b}(q) \dot{\nu} + h_{b}(q,\nu) = \sum J_k^\top f_k
 * \f]
 * where the suffix \f$b\f$ indicates the first 6 rows of the vector/matrix. \f$J_k\f$ is the robot
 * jacobian associated to the contact wrench \f$d_k\f$.
 ...
 */
class BaseDynamicsTask : public Task
{
...
#endif // BIPEDAL_LOCOMOTION_TSID_BASE_DYNAMICS_H
