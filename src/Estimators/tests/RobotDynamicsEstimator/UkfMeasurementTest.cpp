...
TEST_CASE("UkfMeasurement")
{
    ...
    BipedalLocomotion::System::VariablesHandler measurementHandler
        = measurementModel->getMeasurementVariableHandler();
    ...
    currentState.segment(stateVariableHandler.getVariable("tau_m").offset,
                         stateVariableHandler.getVariable("tau_m").size)
        = motorTorques;
    currentState.segment(stateVariableHandler.getVariable("r_leg_ft").offset,
                         stateVariableHandler.getVariable("r_leg_ft").size)
        = wrenchFTtLeg;
    currentState.segment(stateVariableHandler.getVariable("r_foot_front_ft").offset,
                         stateVariableHandler.getVariable("r_foot_front_ft").size)
        = wrenchFTFootFront;
    currentState.segment(stateVariableHandler.getVariable("r_foot_rear_ft").offset,
                         stateVariableHandler.getVariable("r_foot_rear_ft").size)
        = wrenchFTFootRear;
    currentState.segment(stateVariableHandler.getVariable("r_foot_rear_ft").offset,
                         stateVariableHandler.getVariable("r_foot_rear_ft").size)
        = wrenchFTFootRear;
    ...
    Eigen::MatrixXd updatedMeasurement
        = bfl::any::any_cast<Eigen::MatrixXd&&>(std::move(updatedMeasurementTmp));
}
