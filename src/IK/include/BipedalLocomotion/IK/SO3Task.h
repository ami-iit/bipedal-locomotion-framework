...
public:
     ...
     * `string` |                       Name of the frame controlled by the SO3Task |    Yes    | |
     * `kp_angular`            | `double` or `vector<double>` |                           Gain of
     * the orientation controller                           |    Yes    | Where the generalized
     * robot velocity is a vector containing the base spatial-velocity (expressed in mixed
     * representation) and the joint velocities.
