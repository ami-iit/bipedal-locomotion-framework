/**
 * @file BaseVelocityTrackingTask.h
 * @authors Davide Gorbani
 * @copyright 2023 Istituto Italiano di Tecnologia (IIT). This software may be modified and
 * distributed under the terms of the BSD-3-Clause license.
 */

#ifndef BIPEDAL_LOCOMOTION_BASE_VELOCITY_REGULARIZATION_TASK_H
#define BIPEDAL_LOCOMOTION_BASE_VELOCITY_REGULARIZATION_TASK_H
...
class BaseVelocityTrackingTask : public IKLinearTask
{
    ...
    Eigen::VectorXd m_desiredBaseVelocity; /**< Desired base velocity expressed in mixed
                                               representation. */
...
public:
     ...
     * `VariablesHandler` describing the robot velocity   |    Yes    |
     ...
     * @param baseVelocity vector containing the desired base velocity expressed in mixed
     * representation.
     * @return True in case of success, false otherwise.
     */
    bool setSetPoint(Eigen::Ref<const Eigen::VectorXd> baseVelocity);
...
BLF_REGISTER_IK_TASK(BaseVelocityTrackingTask)

} // namespace IK
} // namespace BipedalLocomotion

#endif // BIPEDAL_LOCOMOTION_BASE_VELOCITY_REGULARIZATION_TASK_H
