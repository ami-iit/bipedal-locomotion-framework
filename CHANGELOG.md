...
### Fixed
- Fix bug in `YarpRobotControl` (https://github.com/ami-iit/bipedal-locomotion-framework/pull/979)
...
- Change logic of `RobotDynamicsEstimator` (https://github.com/ami-iit/bipedal-locomotion-framework/pull/959)
...
- Fix logic for friction torque saturation in `JointTorqueControlDevice` (https://github.com/ami-iit/bipedal-locomotion-framework/pull/965)
