...
def test_swing_foot_planner_state():
    ...
    state.transform = blf.manif.SE3(position=np.array([0.0, -0.2, 0.5]),
...
def test_swing_foot_planner():
    ...
    # First footstep
    tf1 = blf.manif.SE3(position=[0.9, 0, 0],
    ...
    # Second footstep
    tf2 = blf.manif.SE3(position=[0.8899, 0.1345, 0.0600],
    ...
    # Third footstep
    tf3 = blf.manif.SE3(position=[0.8104, 0.3915, 0.1800],
    ...
    # Fourth footstep
    tf4 = blf.manif.SE3(position=[0.6585, 0.6135, 0.3000],
    ...
    # Fifth footstep
    tf5 = blf.manif.SE3(position=[0.3261, 0.8388, 0.4800],
